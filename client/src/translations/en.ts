export default {
  ...
  about: {
    ...
    description1: "Villa Ingrosso is an elegant vacation home located in the picturesque Leporano, just 300 meters from the crystal-clear waters of the Mediterranean.",
    description2: "Our villa combines traditional Apulian charm with contemporary design and modern comforts for an unforgettable stay.",
    feature1: "300m from the sea",
  ...
  whatsapp: {
    ...
    welcome_title: "Hello! 👋",
    welcome_message: "Welcome to Villa Ingrosso. How can we help you today?",
    quick_messages: "Quick messages:",
    custom_message: "Or write your own message:",
    placeholder: "Write your message...",
    call_button: "Call",
    send_button: "Send on WhatsApp",
    redirect_note: "You will be redirected to WhatsApp",
    quick_msg_1: "Hi! I would like information about Villa Ingrosso for my vacation.",
    quick_msg_2: "I'm interested in booking. Could you send me the availability?",
    quick_msg_3: "I would like to know the prices for the next few weeks.",
    quick_msg_4: "I need help organizing my stay."
  },
  footer: {
  ...
  privacy: {
    ...
    intro: "This Privacy Policy describes how your personal data is collected, used, and shared when you visit or interact with the Villa Ingrosso website.",
    collect: {
      title: "Information We Collect",
      description: "When you visit our website, we automatically collect certain information about your device, including information about your web browser, IP address, time zone, and some of the cookies that are installed on your device.",
    },
    use: {
      title: "How We Use Your Personal Information",
      description: "We use the information that we collect to:",
      item1: "Manage reservations and inquiries",
      item2: "Communicate with you about our services",
      item3: "Improve and optimize our website",
      item4: "Prevent fraudulent activities",
    },
    share: {
      title: "Sharing Your Personal Information",
      description: "We share your personal information only with third parties that help us use your personal information as described above.",
    },
    rights: {
      title: "Your Rights",
      description: "If you are a European resident, you have the right to access the personal information we hold about you and to ask that your personal information be corrected, updated, or deleted.",
    },
    changes: {
      title: "Changes",
  ...
  admin: {
    ...
    bookings: {
      ...
      detailsDescription: "Complete information about the selected booking",
      ...
      confirmDelete: "Are you sure you want to permanently delete this booking?",
      deleteSuccess: "Booking deleted",
      deleteSuccessDesc: "The booking has been successfully deleted",
      deleteError: "Deletion error",
      statusUpdateSuccess: "Status updated",
      statusUpdateSuccessDesc: "The booking status has been updated",
    ...
    messages: {
      ...
      formTitle: "Contact Requests",
      description: "View and manage received messages",
      formDescription: "Manage user requests sent through the contact form",
    ...
    chat: {
      ...
      chatDescription: "Real-time conversations with platform users",
      users: "Users",
      noUsers: "No users found",
      selectUser: "Select a user to view the chat",
      noMessages: "No messages found",
      messagePlaceholder: "Write a message...",
      send: "Send",
      messageSent: "Message sent",
      messageSentDescription: "The message has been sent successfully",
      error: "Error",
    },
  },
};